    ...
    return (
        <Box id="about" sx={{ py: 15, position: 'relative', overflow: 'hidden' }}>
            ...
            <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
                ...
                >
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 6, gap: 2 }}>
                        <Box sx={{ height: '2px', width: '50px', background: 'linear-gradient(90deg, transparent, #4d5dfb)' }} />
                        <Typography variant="h2" align="center" color="primary.main" sx={{ fontWeight: 800, letterSpacing: '-1px' }}>
                    ...
                    <Box sx={{
                        ...
                        <Typography variant="body1" align="center" sx={{ color: 'rgba(255,255,255,0.8)', fontSize: '1.2rem', lineHeight: 1.8, mb: 3 }}>
                        ...
                        <Typography variant="body1" align="center" sx={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', fontStyle: 'italic', position: 'relative', display: 'inline-block', width: '100%' }}>
